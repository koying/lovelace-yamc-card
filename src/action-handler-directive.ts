...
customElements.define('action-handler-media', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-media')) {
    return body.querySelector('action-handler-media') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-media');
